...
export default function ProfilePage() {
  ...
  return (
    <section className="space-y-6">
      <PageIntro
        eyebrow="Perfil"
        title="Perfil e encerramento de conta"
        description="Gerencie sua assinatura e conta."
      />
      ...
      <Panel className="space-y-4">
        ...
        <p className="text-sm text-slate-300">
          Consulte os termos públicos da plataforma.
        </p>
        <button
          type="button"
          onClick={() => navigate("/termo")}
          className="rounded-2xl border border-white/10 bg-white/6 px-5 py-3 text-sm font-semibold text-slate-100 transition hover:bg-white/10"
        >
